        ...
        <section class="w-3/5 p-4 overflow-y-auto" style="max-height: 100vh;">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center space-x-2">
                    <input
                        ...
                        class="border rounded-lg py-2 px-4 mr-5 w-[52rem] xl:w-[52rem] lg:w-[33.5rem] xl:mr-5 lg:mr-1"
                    />
            ...
            <div class="grid grid-cols-4 gap-4 mb-4">
                <div class="bg-white p-4 rounded-lg shadow">
                    <i class="fa-solid fa-mug-hot text-[#f2bc14] text-6xl mb-12 xl:mb-12 lg:mb-6 xl:text-6xl lg:text-4xl"></i>
                    <p class="font-bold">Drink</p>
                    <div>20 items</div>
                </div>
                <div class="bg-white p-4 rounded-lg shadow">
                    <i class="fas fa-ellipsis-h text-[#f2bc14] text-6xl mb-12 xl:mb-12 lg:mb-6 xl:text-6xl lg:text-4xl"></i>
                    <p class="font-bold">Etc.</p>
                    <div>30 items</div>
                </div>
            </div>

            <div class="grid grid-cols-3 gap-4 lg:gap-2 xl:gap-3">
                @foreach ($product as $row)
                    <div class="bg-white p-4 rounded-lg shadow-lg max-w-xs xl:p-4 lg:p-2">
            ...
            <div>
                <div class="bg-[#f1f4fd] px-5 py-5 rounded-md mb-5 mt-5">
                    ...
                    <div class="flex justify-between text-md font-bold">
                        ...
                        <div class="text-base xl:text-base lg:text-xs" id="total-amount">Rp 0</div>
                    </div>
                </div>
            </div>
