...
<body class="bg-gray-100 flex">
    ...
    <section class="w-4/5 px-10 py-10">
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-semibold">Create Product Out</h1>
                <p class="text-gray-600">Tambahkan stok barang keluar baru di sini</p>
            </div>
        </div>

        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('product_out.store') }}" method="POST">
                @csrf
                <div class="mb-4">
